...
var ge = (e, t, r) => rs(e, typeof t != "symbol" ? t + "" : t, r), zr = (e, t, r) => t.has(e) || Dn("Cannot " + r);
var o = (e, t, r) => (zr(e, t, "read from private field"), r ? r.call(e) : t.get(e)), C = (e, t, r) => t.has(e) ? Dn("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), E = (e, t, r, n) => (zr(e, t, "write to private field"), n ? n.call(e, r) : t.set(e, r), r), D = (e, t, r) => (zr(e, t, "access private method"), r);
const ne = Symbol("uninitialized"), ns = "http://www.w3.org/1999/xhtml", $n = !1;
var Xn = Array.isArray, is = Array.prototype.indexOf, kr = Array.prototype.includes, Or = Array.from, Jn = Object.defineProperty, rr = Object.getOwnPropertyDescriptor, ss = Object.getOwnPropertyDescriptors, as = Object.prototype, ls = Array.prototype, Qn = Object.getPrototypeOf, Pn = Object.isExtensible;
const os = () => {
};
function fs(e) {
...
const se = 2, Ht = 4, Lr = 8, ti = 1 << 24, De = 16, Me = 32, et = 64, Xr = 128, hn = 256, Ce = 512, ie = 1024, te = 2048, Fe = 4096, ce = 8192, xe = 16384, Gt = 32768, Jr = 1 << 25, jt = 65536, Sr = 1 << 17, cs = 1 << 18, qt = 1 << 19, vs = 1 << 20, Ge = 1 << 25, bt = 65536, Tr = 1 << 21, It = 1 << 22, ot = 1 << 23, Vr = Symbol("$state"), ri = Symbol("component"), ds = Symbol(""), wr = Symbol("attributes"), Qr = Symbol("class"), hs = Symbol("style"), $t = Symbol("text"), vr = new class extends Error {
  constructor() {
    super(...arguments);
...
function Kt(e) {
  ...
  return t.i = !0, _e = t.p, si(e);
}
function si(e = {}) {
  return Jn(e, ri, { value: !0 }), e;
}
function ai() {
  return !0;
}
...
function _n(e) {
  (e.f & Ce) !== 0 || e.deps === null ? $(e, ie) : $(e, Fe);
}
function li(e) {
  if (e !== null)
    for (const t of e)
      (t.f & se) === 0 || (t.f & bt) === 0 || (t.f ^= bt, li(
        /** @type {Derived} */
        t.deps
      ));
}
function oi(e, t, r) {
  (e.f & te) !== 0 ? t.add(e) : (e.f & Fe) !== 0 && r.add(e), li(e.deps), $(e, ie);
}
function dr(e) {
  var t = L, r = P;
  Re(null), Ke(null);
...
function ui(e) {
  var t = gn(e);
  if (!e.equals(t) && (e.wv = Ii(), (!(k != null && k.is_fork) || e.deps === null) && (k !== null ? (k.capture(e, t, !0), nr == null || nr.capture(e, t, !0)) : e.v = t, e.deps === null))) {
    $(e, ie);
    return;
  }
...
var Fn = 0;
let Us = 1;
var Nt, st, ht, Ot, Lt, Dt, We, Pt, de, lr, Ze, Ne, He, Ft, _t, B, tn, Jt, rn, vi, di, Ct, Hs, Qt;
const Rr = class Rr {
  constructor() {
    C(this, B);
    ge(this, "id", Us++);
     ...
     */
    C(this, Ot, /* @__PURE__ */ new Set());
    /**
     * If a fork is discarded, we need to destroy any effects that are no longer needed
     * @type {Set<(batch: Batch) => void>}
     */
    C(this, Lt, /* @__PURE__ */ new Set());
    /**
     ...
     * @type {Set<Effect>}
     */
    C(this, Ze, /* @__PURE__ */ new Set());
    /**
     * Deferred effects that are MAYBE_DIRTY
     * @type {Set<Effect>}
     */
    C(this, Ne, /* @__PURE__ */ new Set());
    /**
  ...
  flush() {
    try {
      ...
      Fn = 0, en = null, Rt = null, yr = null, qr = !1, k = null, ae = null, qe.clear();
    }
  }
  discard() {
    var t;
  ...
  decrement(t, r) {
    if (E(this, Dt, o(this, Dt) - 1), t) {
      let n = o(this, We).get(r) ?? 0;
      n === 1 ? o(this, We).delete(r) : o(this, We).set(r, n - 1);
    }
  ...
  settled() {
    return (o(this, Pt) ?? E(this, Pt, ei())).promise;
  }
  static ensure() {
    if (k === null) {
      const t = k = new Rr();
  ...
  schedule(t) {
    var i;
    if (en = t, (i = t.b) != null && i.is_pending && (t.f & (Ht | Lr | ti)) !== 0 && (t.f & Gt) === 0) {
      t.b.defer_effect(t);
      return;
    }
...
Nt = new WeakMap(), st = new WeakMap(), ht = new WeakMap(), Ot = new WeakMap(), Lt = new WeakMap(), Dt = new WeakMap(), We = new WeakMap(), Pt = new WeakMap(), de = new WeakMap(), lr = new WeakMap(), Ze = new WeakMap(), Ne = new WeakMap(), He = new WeakMap(), Ft = new WeakMap(), _t = new WeakMap(), B = new WeakSet(), tn = function() {
  if (this.is_fork) return !0;
  for (const n of o(this, We).keys()) {
  ...
  var f, v, d, _;
  E(this, Nt, !0), Fn++ > 1e3 && (D(this, B, Qt).call(this), js());
  for (const c of o(this, Ze))
    o(this, Ne).delete(c), $(c, te), this.schedule(c);
  for (const c of o(this, Ne))
    $(c, Fe), this.schedule(c);
  const t = o(this, de);
  ...
  for (const c of t)
    try {
      ...
      throw pi(c), D(this, B, tn).call(this) || this.discard(), h;
    }
  ...
  const a = D(this, B, vi).call(this);
  if (a) {
    D(this, B, Ct).call(this, n), D(this, B, Ct).call(this, r), D(v = a, B, di).call(v, this);
    return;
  }
  o(this, Ze).clear(), o(this, Ne).clear();
  for (const c of o(this, Ot)) c(this);
  o(this, Ot).clear(), nr = this, Un(n), Un(r), nr = null, (d = o(this, Pt)) == null || d.resolve();
  var l = (
    /** @type {Batch | null} */
    /** @type {unknown} */
    k
    ...
    if (s !== null && !((i.f & se) !== 0 && (i.f & (te | Fe)) === 0))
      for (const f of s) {
        ...
        if ((a & se) !== 0)
          ...
          a & (It | De) && !this.async_deriveds.has(l) && (o(this, Ne).delete(l), $(l, te), this.schedule(l));
        }
      }
  };
      ...
      if (s.length === 0)
        ...
        if (v.length > 0)
          for (const h of o(this, lr))
            (h.f & (xe | ce | Sr)) === 0 && mn(h, v, l) && ((h.f & (It | De)) !== 0 ? ($(h, te), c.schedule(h)) : o(c, Ze).add(h));
...
function Un(e) {
  ...
  if (t !== 0) {
    for (var r = 0; r < t; ) {
      var n = e[r++];
      if ((n.f & (xe | ce)) === 0 && _r(n) && (Ie = /* @__PURE__ */ new Set(), Vt(n), n.deps === null && n.first === null && n.nodes === null && n.teardown === null && n.ac === null && Ti(n), (Ie == null ? void 0 : Ie.size) > 0)) {
        qe.clear();
        for (const i of Ie) {
  ...
  if (!r.has(e) && (r.add(e), e.reactions !== null))
    for (const i of e.reactions) {
      ...
      (s & se) !== 0 ? hi(
        ...
        r,
        n
      ) : (s & (It | De)) !== 0 && (s & te) === 0 && mn(i, t, n) && ($(i, te), wn(
        /** @type {Effect} */
        i
      ));
    }
...
function _i(e, t) {
  if (!((e.f & Me) !== 0 && (e.f & ie) !== 0)) {
    (e.f & te) !== 0 ? t.d.push(e) : (e.f & Fe) !== 0 && t.m.push(e), $(e, ie);
...
function T(e, t, r = !1) {
  ...
  (!Pe || (L.f & Sr) !== 0) && ai() && (L.f & (se | De | It | Sr)) !== 0 && (Ye === null || !Ye.has(e)) && As();
  let n = r ? Je(t) : t;
  return zt(e, n, yr);
}
function zt(e, t, r = null) {
  if (!e.equals(t)) {
    ...
    e.wv = Ii(), mi(e, te, r), P !== null && (P.f & ie) !== 0 && (P.f & (Me | et)) === 0 && (ke === null ? ta([e]) : ke.push(e)), !n.is_fork && Cr.size > 0 && !gi && zs();
  }
  return t;
}
function zs() {
  ...
  if (n !== null)
    for (var i = n.length, s = 0; s < i; s++) {
      ...
      if (f && $(a, t), (l & Sr) !== 0)
        ...
        ae == null || ae.delete(v), (l & bt) === 0 && (l & Ce && (P === null || (P.f & Tr) === 0) && (a.f |= bt), mi(v, Fe, r));
      } else if (f) {
        var d = (
          /** @type {Effect} */
          a
...
function Je(e) {
  if (typeof e != "object" || e === null || Vr in e || ri in e)
    return e;
  const t = Qn(e);
  if (t !== as && t !== ls)
    return e;
  var r = /* @__PURE__ */ new Map(), n = Xn(e), i = /* @__PURE__ */ V(0), s = yt, a = (l) => {
    if (yt === s)
      return l();
    var f = L, v = yt;
    Re(null), jn(s);
    ...
    e,
    {
      ...
      set(l, f, v, d) {
        ...
        if (n && f === "length")
          ...
          _.v; h += 1) {
            var m = r.get(h + "");
            m !== void 0 ? T(m, ne) : h in l && (m = a(() => /* @__PURE__ */ V(ne)), r.set(h + "", m));
          }
        if (_ === void 0)
          (!c || (H = rr(l, f)) != null && H.writable) && (_ = a(() => /* @__PURE__ */ V(void 0)), T(_, Je(v)), r.set(f, _));
        else {
          c = _.v !== ne;
          var w = a(() => Je(v));
          T(_, w);
        ...
        if (p != null && p.set && p.set.call(d, v), !c) {
          if (n && typeof f == "string") {
            ...
            Number.isInteger(X) && X >= b.v && T(b, X + 1);
          }
          ir(i);
        }
        return !0;
...
function Vs() {
  if (nn === void 0) {
    nn = window, wi = /Firefox/.test(navigator.userAgent);
    var e = Element.prototype, t = Node.prototype, r = Text.prototype;
    yi = rr(t, "firstChild").get, bi = rr(t, "nextSibling").get, Pn(e) && (e[Qr] = void 0, e[wr] = null, e[hs] = void 0, e.__e = void 0), Pn(r) && (r[$t] = void 0);
  }
}
function Qe(e = "") {
...
function tt(e, t) {
  ...
  if (i !== null && (i.parent = r, r !== null && Ws(i, r), L !== null && (L.f & se) !== 0 && (e & et) === 0)) {
    var s = (
      /** @type {Derived} */
      L
    );
...
function Ci(e, t) {
  if ((e.f & hn) === 0 && (e.f & ce) !== 0) {
    e.f ^= ce, (e.f & ie) === 0 && ($(e, te), Et.ensure().schedule(e));
    for (var r = e.first; r !== null; ) {
...
function Oi(e) {
  ...
  try {
    ...
    e.f |= Gt;
    var c = Bn(e);
    if (ai() && ke !== null && !Pe && c !== null && (e.f & (se | Fe | te)) === 0)
...
function Vt(e) {
  ...
  if ((t & xe) === 0) {
    ...
    P = e, br = (t & (Me | et)) === 0;
    try {
      (t & (De | ti)) !== 0 ? Qs(e) : xn(e), Si(e);
      var i = Oi(e);
      e.teardown = typeof i == "function" ? i : null, e.wv = Ri;
      var s;
      $n && Ms && (e.f & te) !== 0 && e.deps;
    } finally {
      br = n, P = r;
    }
  }
...
function u(e) {
  ...
  if (r) {
    ...
    if (ut) {
      var l = a.v;
      return ((a.f & ie) === 0 && a.reactions !== null || Di(a)) && (l = gn(a)), qe.set(a, l), l;
    }
    var f = (a.f & Ce) === 0 && !Pe && L !== null && (br || (L.f & Ce) !== 0), v = (a.f & Gt) === 0;
    _r(a) && (f && (a.f |= Ce), ui(a)), f && !v && (ci(a), Li(a));
  }
  if (ae != null && ae.has(e))
    return ae.get(e);
  if ((e.f & ot) !== 0)
...
function Li(e) {
  if (e.f |= Ce, e.deps !== null)
    for (const t of e.deps)
      (t.reactions ?? (t.reactions = [])).push(e), (t.f & se) !== 0 && (t.f & Ce) === 0 && (ci(
        /** @type {Derived} */
        t
      ), Li(
        /** @type {Derived} */
...
const Wr = (
  // We gotta write it like this because after downleveling the pure comment may end up in the wrong location
  ((Wn = globalThis == null ? void 0 : globalThis.window) == null ? void 0 : Wn.trustedTypes) && /* @__PURE__ */ globalThis.window.trustedTypes.createPolicy("svelte-trusted-html", {
    /** @param {string} html */
    createHTML: (e) => e
  })
);
function ia(e) {
  return (
    /** @type {string} */
    (Wr == null ? void 0 : Wr.createHTML(e)) ?? e
  );
}
function Ui(e) {
  var t = qs("template");
...
var Se, dn, Te, pt, fe, me, ue, we, je, gt, at, Ut, or, fr, $e, Ir, G, da, ha, ln, _a, on, er, xr, fn, un;
class va {
  /**
  ...
  constructor(t, r, n, i) {
     ...
     */
    C(this, $e, null);
    C(this, Ir, fa(() => (E(this, $e, kt(o(this, gt))), () => {
      E(this, $e, null);
    })));
    var s;
  ...
  update_pending_count(t, r) {
    D(this, G, fn).call(this, t, r), E(this, gt, o(this, gt) + t), !(!o(this, $e) || o(this, Ut)) && (E(this, Ut, !0), Xe(() => {
      E(this, Ut, !1), o(this, $e) && zt(o(this, $e), o(this, gt));
    }));
  }
  get_effect_pending() {
...
Se = new WeakMap(), dn = new WeakMap(), Te = new WeakMap(), pt = new WeakMap(), fe = new WeakMap(), me = new WeakMap(), ue = new WeakMap(), we = new WeakMap(), je = new WeakMap(), gt = new WeakMap(), at = new WeakMap(), Ut = new WeakMap(), or = new WeakMap(), fr = new WeakMap(), $e = new WeakMap(), Ir = new WeakMap(), G = new WeakSet(), da = function() {
  try {
...
function W(e, t) {
  ...
  r !== /** @type {any} */
  (e[$t] ?? (e[$t] = e.nodeValue)) && (e[$t] = r, e.nodeValue = `${r}`);
}
function pa(e, t) {
  return ga(e, t);
}
  ...
  var f = void 0, v = Zs(() => {
    ...
    ca(
      ...
      (h) => {
        ...
        s && (m.c = s), i && (n.$$events = i), f = e(h, n) || si(), Kt();
      },
      l
    );
...
function lt(e, t, r, n, i, s = null) {
  ...
  var b = Dr(() => {
    c = /** @type {V[]} */
    u(_);
    for (var H = c.length, Q = /* @__PURE__ */ new Set(), A = (
      /** @type {Batch} */
      k
    ), I = xi(), g = 0; g < H; g += 1) {
      var M = c[g], q = n(M, g), j = m ? null : l.get(q);
      j ? (j.v && zt(j.v, M), j.i && zt(j.i, g), I && A.unskip_effect(j.e)) : (j = Ea(
        l,
        m ? a : zn ?? (zn = Qe()),
        M,
        q,
    ...
    if (H === 0 && s && !d && (m ? d = Ae(() => s(a)) : (d = Ae(() => s(zn ?? (zn = Qe()))), d.f |= Ge)), H > Q.size && ys(), !m)
      if (h.set(A, Q), I) {
        for (const [le, ve] of l)
          Q.has(le) || A.skip_effect(ve.e);
...
function xa(e, t, r, n, i) {
  ...
  var s = (n & 8) !== 0, a = t.length, l = e.items, f = Zt(e.effect.first), v, d = null, _, c = [], h = [], m, w, p, b;
  if (s)
    for (b = 0; b < a; b += 1)
  ...
  for (b = 0; b < a; b += 1) {
    ...
    if ((p.f & ce) !== 0 && (Mr(p), s && ((oe = (ve = p.nodes) == null ? void 0 : ve.a) == null || oe.unfix(), (_ ?? (_ = /* @__PURE__ */ new Set())).delete(p))), (p.f & Ge) !== 0)
      if (p.f ^= Ge, p === f)
        ...
        var X = d ? d.next : f;
        p === e.effect.last && (e.effect.last = p.prev), p.prev && (p.prev.next = p.next), p.next && (p.next.prev = p.prev), it(e, d, p), it(e, p, X), tr(p, X, r), d = p, c = [], h = [], f = Zt(d.next);
        continue;
      }
    if (p !== f) {
      if (v !== void 0 && v.has(p)) {
        if (c.length < h.length) {
          ...
          for (Q = 0; Q < h.length; Q += 1)
            v.delete(h[Q]);
          it(e, A.prev, I.next), it(e, d, A), it(e, I, H), f = H, d = I, b -= 1, c = [], h = [];
        } else
  ...
  if (f !== null || v !== void 0) {
    ...
    if (v !== void 0)
      for (p of v)
        (p.f & ce) === 0 && g.push(p);
    for (; f !== null; )
      (f.f & ce) === 0 && f !== e.fallback && g.push(f), f = Zt(f.next);
    var M = g.length;
    if (M > 0) {
    ...
    for (var i of Object.keys(r))
      if (r[i])
        ...
        for (var s = i.length, a = 0; (a = n.indexOf(i, a)) >= 0; ) {
          var l = a + s;
          (a === 0 || Vn.includes(n[a - 1])) && (l === n.length || Vn.includes(n[l])) ? n = (a === 0 ? "" : n.substring(0, a)) + n.substring(l + 1) : a = l;
        }
  }
  return n === "" ? null : n;
}
...
const Ia = "5";
var Zn;
typeof window < "u" && ((Zn = window.__svelte ?? (window.__svelte = {})).v ?? (Zn.v = /* @__PURE__ */ new Set())).add(Ia);
let Fr = "";
function Na(e) {
  Fr = e;
}
...
function Ka(e, t) {
  ...
  async function _(x, R) {
    ...
    F ? (T(n, R === 0 ? F.items : [...u(n), ...F.items], !0), T(i, F.total, !0), T(f, x, !0), T(a, !1)) : T(a, !0), T(s, !1);
  }
  bn(() => {
    _("", 0);
  });
  function c(x) {
    T(l, x.currentTarget.value, !0), clearTimeout(v), v = setTimeout(() => _(u(l), 0), 250);
  }
  function h(x) {
  ...
  var m = Ya(), w = O(ft(m), 2), p = Z(w);
  {
    var b = (x) => {
      ...
      var R = Zr("no accounts indexed yet");
      S(x, R);
    };
    K(p, (x) => {
  ...
  lt(q, 17, () => u(n), (x) => x.handle, (x, R) => {
    ...
    Y(() => {
      ze(F, "href", `/x/onlyfans/${u(R).handle ?? ""}`), ze(re, "title", u(R).display_name), W(Tt, u(R).display_name), W(Ur, `${u(R).source_count ?? ""}
  ...
  Y(() => Ma(A, u(l))), Le("input", A, c), S(e, m), Kt();
}
Sn(["input", "click"]);
var Wa = /* @__PURE__ */ U('<p class="ofx-error"> </p>'), Za = /* @__PURE__ */ U('<p class="ofx-note"> </p>'), qn = /* @__PURE__ */ U('<span class="ofx-badge"> </span>'), $a = /* @__PURE__ */ U('<button class="ofx-tile" type="button"><div class="ofx-thumb"><!> <!></div> <p> </p></button>'), Xa = /* @__PURE__ */ U('<div class="ofx-skeleton"></div>'), Ja = /* @__PURE__ */ U('<button class="ofx-btn ofx-outline" type="button"> </button>'), Qa = /* @__PURE__ */ U('<section class="ofx-section"><h2> </h2> <!> <div class="ofx-tiles"><!> <!></div> <!></section>');
function el(e, t) {
  Yt(t, !0);
  ...
  async function l() {
    if (u(i) || u(s)) return;
    T(i, !0);
    const A = u(n) + 1, g = await (t.mode === "images" ? Pa : Da)(t.handle, t.site, A);
    g === null ? T(a, !0) : (T(r, [...u(r), ...g], !0), T(n, A), g.length === 0 && T(s, !0)), T(i, !1);
  }
  bn(() => {
    t.mode, t.handle, t.site, kn(() => {
      T(r, [], !0), T(n, 0), T(s, !1), T(a, !1), T(i, !1), l();
    });
  });
  function f(A) {
    return A ? `${Math.floor(A / 60)}:${String(A % 60).padStart(2, "0")}` : null;
  }
  var v = Qa(), d = Z(v), _ = ee(d, !0), c = O(d, 2);
  {
    var h = (A) => {
      var I = Wa(), g = ee(I);
      Y(() => W(g, `${t.site ?? ""} did not answer.`)), S(A, I);
    }, m = (A) => {
      var I = Za(), g = ee(I);
      Y(() => W(g, `Nothing here on ${t.site ?? ""}.`)), S(A, I);
    };
    K(c, (A) => {
  ...
  var w = O(c, 2), p = Z(w);
  lt(p, 17, () => u(r), (A) => A.video_id ?? A.gallery_id, (A, I) => {
    var g = $a(), M = Z(g), q = Z(M);
    {
    ...
    var j = O(q, 2);
    {
      var le = (F) => {
        var J = qn(), Ee = ee(J, !0);
        Y(() => W(Ee, u(I).image_count)), S(F, J);
      }, ve = (F) => {
        var J = qn(), Ee = ee(J, !0);
        Y((re) => W(Ee, re), [() => f(u(I).duration)]), S(F, J);
    ...
    Y(() => W(R, u(I).title)), Le("click", g, () => t.mode === "images" ? t.ongallery(u(I)) : t.onplay(u(I))), S(A, g);
  });
  var b = O(p, 2);
  {
    var X = (A) => {
...
function wl(e, t) {
  ...
  function d(g) {
    const M = new Set(u(s));
    M.has(g) ? M.delete(g) : M.add(g), T(s, M, !0);
  }
  async function _(g) {
    T(f, null);
    ...
    T(l, { gallery: g, count: M.length, index: 0 }, !0);
  }
  function c(g) {
    u(l) && T(
      l,
  ...
  var w = ft(m);
  {
    var p = (g) => {
      ...
      var F = O(x, 2), J = Z(F), Ee = Z(J), re = O(Ee);
      {
        var Tt = (y) => {
          var N = nl();
          S(y, N);
      ...
      var An = O(rt, 2);
      {
        var Vi = (y) => {
          ...
          lt(N, 21, () => u(v), ([z, Ue]) => z, (z, Ue) => {
            ...
            var nt = sl(), Wt = Z(nt), Br = ee(Wt, !0), Qi = O(Wt);
            Y(
              (es) => {
                W(Br, es), W(Qi, ` ${Hr() ?? ""}`);
              },
      ...
      var Gi = O(An, 2), Cn = Z(Gi);
      {
        var qi = (y) => {
          var N = ll(), z = ee(N, !0);
          Y(() => W(z, u(r).location)), S(y, N);
        };
        K(Cn, (y) => {
          u(r).location && y(qi);
        });
      ...
      var Ki = O(Mn, 2);
      {
        var Wi = (y) => {
          var N = Yn(), z = ee(N);
          Y(() => {
            ze(N, "href", u(r).of_url), W(z, `onlyfans.com/${u(r).of_username ?? ""}`);
          }), S(y, N);
        };
        K(Ki, (y) => {
          u(r).of_url && y(Wi);
      ...
      var Rn = O(q, 2), In = Z(Rn);
      lt(In, 20, () => ["videos", "images"], (y) => y, (y, N) => {
        var z = ol();
        let Ue;
        var ct = ee(z, !0);
        Y(() => {
          Ue = $r(z, 1, "ofx-btn", null, Ue, { "ofx-on": u(i) === N }), W(ct, N);
        }), Le("click", z, () => T(i, N, !0)), S(y, z);
      });
      var Nn = O(In, 4);
      lt(Nn, 17, () => u(r).sources, (y) => y.site, (y, N) => {
        var z = ul();
        let Ue;
        var ct = Z(z), Hr = O(ct);
        {
          var jr = (nt) => {
            var Wt = fl(), Br = ee(Wt, !0);
            Y(() => W(Br, u(N).video_count)), S(nt, Wt);
          };
          K(Hr, (nt) => {
        ...
        Y(
          (nt) => {
            Ue = $r(z, 1, "ofx-btn ofx-outline", null, Ue, { "ofx-on": nt }), W(ct, `${u(N).site ?? ""} `);
          },
          [() => u(s).has(u(N).site)]
        ), Le("click", z, () => d(u(N).site)), S(y, z);
      });
      var Zi = O(Nn, 2), On = O(Rn, 2);
      {
        var $i = (y) => {
          var N = cl(), z = ee(N, !0);
          Y(() => W(z, u(f))), S(y, N);
      ...
      lt(Ji, 17, () => u(r).sources.filter((y) => u(s).has(y.site)), (y) => y.site, (y, N) => {
        ...
        oe = $r(ve, 1, "ofx-identity", null, oe, { "ofx-overlap": !!u(r).header_url }), W(Ee, `${u(r).display_name ?? ""} `), W(Ur, `${u(r).source_count ?? ""}
                    ${u(r).source_count === 1 ? "site" : "sites"} · ${u(r).handle ?? ""}`);
      }), Le("click", Zi, () => t.navigate("/x/onlyfans")), S(g, M);
    }, X = (g) => {
      var M = hl();
      S(g, M);
    };
  ...
  {
    var Q = (g) => {
      var M = _l(), q = Z(M), j = O(q, 2);
      Y((le) => ze(j, "src", le), [
        () => Ha(u(a).site, u(a).video_id)
      ]), Le("click", q, () => T(a, null)), S(g, M);
    };
    K(H, (g) => {
      u(a) && g(Q);
    });
