/*
    ...
    like a stylesheet that failed to load. It did not: the OnlyFans page was
    ...
    Keep authoring plain `.ofx-*` selectors; this is a build step, not a
...
const outrankHostPreflight = {
    ...
    Rule(rule) {
        ...
        // shape: `.ofx-card img` stays a card's image.
